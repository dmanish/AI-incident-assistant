...
- `app/main.py:785-835` - POST /agent/routing/feedback
- `app/main.py:838-855` - GET /agent/routing/feedback/stats
- `app/main.py:858-893` - POST /agent/routing/learn
...
**Key Methods in `app/agent/routing_feedback.py` (342 lines):**
- `record_feedback()` - Lines 69-122: Record user feedback
- `analyze_feedback_patterns()` - Lines 123-180: Analyze patterns in feedback
- `generate_training_examples()` - Lines 181-232: Auto-generate training examples
- `export_training_examples()` - Lines 233-264: Export examples to JSON
- `get_feedback_stats()` - Lines 278-306: Get statistics
